...
import com.nicole.insultgenerator.InsultGeneratorApplication;
...
public class InsultControllerTest {
    ...
    public void getInsultForName () throws Exception {
        ...
        //check name inside body

        ResultActions result = this.mockMvc.perform(
                        MockMvcRequestBuilders.get("/insult/name/{name}", "Nicole"))
                .andDo(
                        print())
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.personToInsult").value("Nicole"));
